...
pub mod msg_client {
    ...
    use tonic::codegen::*;
    #[doc = " Msg defines the oracle Msg service."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn store_code(
            ...
            let path = http::uri::PathAndQuery::from_static("/terra.wasm.v1beta1.Msg/StoreCode");
            self.inner.unary(request.into_request(), path, codec).await
        }
        #[doc = " MigrateCode to submit new version Wasm code to the system"]
        pub async fn migrate_code(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/terra.wasm.v1beta1.Msg/MigrateCode");
            self.inner.unary(request.into_request(), path, codec).await
        }
        ...
        pub async fn instantiate_contract(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path =
                http::uri::PathAndQuery::from_static("/terra.wasm.v1beta1.Msg/InstantiateContract");
            self.inner.unary(request.into_request(), path, codec).await
        }
        ...
        pub async fn execute_contract(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path =
                http::uri::PathAndQuery::from_static("/terra.wasm.v1beta1.Msg/ExecuteContract");
            self.inner.unary(request.into_request(), path, codec).await
        }
        ...
        pub async fn migrate_contract(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path =
                http::uri::PathAndQuery::from_static("/terra.wasm.v1beta1.Msg/MigrateContract");
            self.inner.unary(request.into_request(), path, codec).await
        }
        #[doc = " UpdateContractAdmin sets a new admin for a smart contract"]
        pub async fn update_contract_admin(
            &mut self,
            request: impl tonic::IntoRequest<super::MsgUpdateContractAdmin>,
        ) -> Result<tonic::Response<super::MsgUpdateContractAdminResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path =
                http::uri::PathAndQuery::from_static("/terra.wasm.v1beta1.Msg/UpdateContractAdmin");
            self.inner.unary(request.into_request(), path, codec).await
        }
        #[doc = " ClearContractAdmin remove admin flag from a smart contract"]
        pub async fn clear_contract_admin(
            &mut self,
            request: impl tonic::IntoRequest<super::MsgClearContractAdmin>,
        ) -> Result<tonic::Response<super::MsgClearContractAdminResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path =
                http::uri::PathAndQuery::from_static("/terra.wasm.v1beta1.Msg/ClearContractAdmin");
            self.inner.unary(request.into_request(), path, codec).await
        }
    }
}
...
pub mod query_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " CodeInfo returns the stored code info"]
        pub async fn code_info(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/terra.wasm.v1beta1.Query/CodeInfo");
            self.inner.unary(request.into_request(), path, codec).await
        }
        #[doc = " ByteCode returns the stored byte code"]
        pub async fn byte_code(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/terra.wasm.v1beta1.Query/ByteCode");
            self.inner.unary(request.into_request(), path, codec).await
        }
        #[doc = " ContractInfo returns the stored contract info"]
        pub async fn contract_info(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path =
                http::uri::PathAndQuery::from_static("/terra.wasm.v1beta1.Query/ContractInfo");
            self.inner.unary(request.into_request(), path, codec).await
        }
        #[doc = " ContractStore return smart query result from the contract"]
        pub async fn contract_store(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path =
                http::uri::PathAndQuery::from_static("/terra.wasm.v1beta1.Query/ContractStore");
            self.inner.unary(request.into_request(), path, codec).await
        }
        #[doc = " RawStore return single key from the raw store data of a contract"]
        pub async fn raw_store(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/terra.wasm.v1beta1.Query/RawStore");
            self.inner.unary(request.into_request(), path, codec).await
        }
        ...
        pub async fn params(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/terra.wasm.v1beta1.Query/Params");
            self.inner.unary(request.into_request(), path, codec).await
        }
    }
}
