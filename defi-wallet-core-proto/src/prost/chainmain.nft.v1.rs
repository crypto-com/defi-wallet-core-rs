...
pub mod msg_client {
    ...
    use tonic::codegen::*;
    #[doc = " Msg defines the NFT Msg service."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " IssueDenom defines a method for issue a denom."]
        pub async fn issue_denom(
            ...
            let path = http::uri::PathAndQuery::from_static("/chainmain.nft.v1.Msg/IssueDenom");
            self.inner.unary(request.into_request(), path, codec).await
        }
        #[doc = " MintNFT defines a method for mint a new nft"]
        pub async fn mint_nft(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/chainmain.nft.v1.Msg/MintNFT");
            self.inner.unary(request.into_request(), path, codec).await
        }
        #[doc = " EditNFT defines a method for editing a nft."]
        pub async fn edit_nft(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/chainmain.nft.v1.Msg/EditNFT");
            self.inner.unary(request.into_request(), path, codec).await
        }
        #[doc = " TransferNFT defines a method for transferring a nft."]
        pub async fn transfer_nft(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/chainmain.nft.v1.Msg/TransferNFT");
            self.inner.unary(request.into_request(), path, codec).await
        }
        #[doc = " BurnNFT defines a method for burning a nft."]
        pub async fn burn_nft(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/chainmain.nft.v1.Msg/BurnNFT");
            self.inner.unary(request.into_request(), path, codec).await
        }
    }
}
...
pub mod query_client {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    #[doc = " Query defines the gRPC querier service for NFT module"]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Supply queries the total supply of a given denom or owner"]
        pub async fn supply(
            &mut self,
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/chainmain.nft.v1.Query/Supply");
            self.inner.unary(request.into_request(), path, codec).await
        }
        #[doc = " Owner queries the NFTs of the specified owner"]
        pub async fn owner(
            &mut self,
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/chainmain.nft.v1.Query/Owner");
            self.inner.unary(request.into_request(), path, codec).await
        }
        #[doc = " Collection queries the NFTs of the specified denom"]
        pub async fn collection(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/chainmain.nft.v1.Query/Collection");
            self.inner.unary(request.into_request(), path, codec).await
        }
        #[doc = " Denom queries the definition of a given denom"]
        pub async fn denom(
            &mut self,
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/chainmain.nft.v1.Query/Denom");
            self.inner.unary(request.into_request(), path, codec).await
        }
        #[doc = " DenomByName queries the definition of a given denom by name"]
        pub async fn denom_by_name(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/chainmain.nft.v1.Query/DenomByName");
            self.inner.unary(request.into_request(), path, codec).await
        }
        #[doc = " Denoms queries all the denoms"]
        pub async fn denoms(
            &mut self,
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/chainmain.nft.v1.Query/Denoms");
            self.inner.unary(request.into_request(), path, codec).await
        }
        #[doc = " NFT queries the NFT for the given denom and token ID"]
        pub async fn nft(
            &mut self,
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/chainmain.nft.v1.Query/NFT");
            self.inner.unary(request.into_request(), path, codec).await
        }
    }
}
