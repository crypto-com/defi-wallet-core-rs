...
xcodebuild SYMROOT="./build" -configuration Debug -target dwclib -arch arm64 -sdk iphoneos build
xcodebuild SYMROOT="./build" -configuration Debug -target dwclib -arch x86_64 -sdk iphonesimulator build
cd -
